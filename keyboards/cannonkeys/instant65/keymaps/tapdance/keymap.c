...
tap_dance_action_t tap_dance_actions[] = {
    [TD_ALT_FN] = ACTION_TAP_DANCE_DOUBLE(MO(5), KC_LALT),
};
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[0] = LAYOUT_default(
		...
		KC_LCTL, MO(1),   TD(TD_ALT_FN),                   KC_SPC,                      TT(2),   KC_RCTL,          KC_LEFT, KC_DOWN, KC_RGHT
	...
	[1] = LAYOUT_default(       
		...
		KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,          KC_UP,   KC_PGDN,
		MO(3),   KC_NO,   KC_LGUI,                   MO(4),                             KC_NO, KC_RCTL,          KC_LEFT, KC_DOWN, KC_RGHT
	),
    // toggle key layer
    [2] = LAYOUT_default(
	...
	// tap dance layer
	[5] = LAYOUT_default(
		KC_GRAVE,KC_F1,  KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_BSPC, KC_INS,
		KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC, KC_BSLS, KC_DEL,
		KC_CAPS, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,          KC_ENT,  KC_PGUP,
		KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,          KC_UP,   KC_PGDN,
		KC_LCTL, KC_NO,   KC_LALT,                   KC_SPC,                             KC_NO, KC_RCTL,          KC_LEFT, KC_DOWN, KC_RGHT
